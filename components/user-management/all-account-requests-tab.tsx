  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-xl font-semibold text-gray-900">All Account Requests</h2>
          <p className="text-gray-600">Review and manage all user account requests</p>
        </div>
      </div>
                ...
                return (
                  <TableRow key={request.request_id}>
                    ...
                    <TableCell>
                      {request.reviewed_at ? (
                        <div className="space-y-1">
                          <span className="text-sm">{new Date(request.reviewed_at).toLocaleDateString()}</span>
                          {request.reviewer && (
                            <p className="text-xs text-gray-500">by {request.reviewer.full_name}</p>
                          )}
                        </div>
                      ) : (
