...
export function VillagesTab({ searchQuery }: VillagesTabProps) {
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      if (errorMessage.includes('foreign key') || errorMessage.includes('constraint')) {
        toast.error("Cannot delete village: It is being used by other records (structures, dwelling units, etc.)")
      } else if (errorMessage.includes('permission') || errorMessage.includes('unauthorized')) {
        toast.error("Permission denied: You don't have access to delete this village")
      } else {
  ...
  const filteredVillages = villages.filter(village =>
    ...
    village.site?.country?.name.toLowerCase().includes(searchQuery.toLowerCase())
  )
            ...
            <TableBody>
              {filteredVillages.map((village) => (
                <TableRow key={village.village_id}>
                  ...
                  <TableCell>
                    <Badge variant="secondary">{village.site?.country?.name}</Badge>
                  </TableCell>
                  <TableCell>
                  ...
                  <TableCell className="text-right">
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end">
                        ...
                        <DropdownMenuItem onClick={() => openEditDialog(village)}>
