              ...
              <div className='flex items-center justify-between mb-8'>
                <div>
                  ...
                  <p className='text-gray-600 mt-2'>
                    Find answers, get help, and learn how to use A-Search
                    effectively
                  </p>
                </div>
                  ...
                  {helpCategories.map((category, index) => (
                    ...
                    >
                      <CardContent className='p-6'>
                        <div className='flex items-center justify-between mb-4'>
                          <div
                            className={`p-3 ${category.color} rounded-lg text-white text-xl`}
                          >
                            {category.icon}
                          </div>
                        ...
                        <CardContent className='pt-0'>
                          <div className='space-y-3'>
                            {section.items.map((item, itemIndex) => (
                              <div
                                key={itemIndex}
                                className='text-sm text-gray-700 hover:text-orange-600 cursor-pointer flex items-center gap-2'
                              >
                          ...
                          <Button
                            variant='link'
                            className='text-orange-600 p-0 h-auto font-medium mt-4'
                          >
                            View All →
                          </Button>
                        </CardContent>
              ...
              <div className='mb-8'>
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
                  <Card className='border-0 shadow-md'>
                    <CardContent className='p-6'>
                      <h3 className='font-semibold text-gray-900 mb-2'>
                        How do I start a new research study?
                      </h3>
                      <p className='text-sm text-gray-600 mb-4'>
                        Navigate to the Research & Analytics section and click
                        &quot;Initiate Research&quot; to begin a new study
                        following our 11-step workflow.
                      </p>
                      <Button
                        variant='link'
                  ...
                  <Card className='border-0 shadow-md'>
                    <CardContent className='p-6'>
                      <h3 className='font-semibold text-gray-900 mb-2'>
                        How can I access population data?
                      </h3>
                      <p className='text-sm text-gray-600 mb-4'>
                        Visit the Data Hub to browse available datasets, request
                        access, and download approved data for your research.
                      </p>
                      <Button
                        variant='link'
                        className='text-orange-600 p-0 h-auto text-sm'
                  ...
                  <Card className='border-0 shadow-md'>
                    <CardContent className='p-6'>
                      <h3 className='font-semibold text-gray-900 mb-2'>
                        What is the A-Search Assistant?
                      </h3>
                      <p className='text-sm text-gray-600 mb-4'>
                        Our AI-powered assistant helps with research design,
                        data analysis, and report generation. Upload files and
                        ask questions for instant help.
                      </p>
                      <Button
                        variant='link'
                        className='text-orange-600 p-0 h-auto text-sm'
                  ...
                  <Card className='border-0 shadow-md'>
                    <CardContent className='p-6'>
                      <h3 className='font-semibold text-gray-900 mb-2'>
                        How do I manage household data?
                      </h3>
                      <p className='text-sm text-gray-600 mb-4'>
                        Use the Household Mapping section to manage sites,
                        households, individuals, and dwelling units with our
                        comprehensive tools.
                      </p>
                      <Button
                        variant='link'
