...
const steps: {
...
}[] = [
  {
    ...
    description:
      "Clearly specify the health or population issue you're investigating",
    icon: FileText,
  },
  {
    id: 'define-questions',
  ...
  },
  {
    ...
    description:
      'Break down and structure questions for analysis and data collection',
    icon: Map,
  },
  {
    id: 'identify-data',
...
export default function InitiateResearchPage() {
  ...
  const updateResearchData = (
    ...
    value: string | string[] | { main: string; sub: string }[]
  ) => {
    ...
    switch (step.id) {
          ...
          <div className='space-y-6'>
            ...
            <div>
              ...
              <Textarea
                ...
                onChange={e =>
                  updateResearchData('description', e.target.value)
                }
                className='mt-2'
                rows={4}
              />
      ...
      case 'define-questions':
        return (
          <div className='space-y-6'>
            <div>
              <Label htmlFor='mainQuestion' className='text-base font-medium'>
              ...
              <Input
                ...
                onChange={e =>
                  updateResearchData('mainQuestion', e.target.value)
                }
                className='mt-2 h-12 text-base'
              />
            </div>
                ...
                {researchData.subQuestions.map((question, index) => (
                  <div key={index} className='flex gap-2'>
                    <Input
                      ...
                      value={question}
                      onChange={e =>
                        updateArrayItem('subQuestions', index, e.target.value)
                      }
          ...
          <div className='space-y-6'>
            <div>
              <Label className='text-base font-medium'>
                Map Sub-Questions to Main Questions
              </Label>
                ...
                {researchData.missingData.map((data, index) => (
                  <div key={index} className='flex gap-2'>
                    <Input
                      ...
                      value={data}
                      onChange={e =>
                        updateArrayItem('missingData', index, e.target.value)
                      }
                      className='h-12 text-base'
                    />
                    <Button
                ...
                {researchData.dataCollectionMethods.map((method, index) => (
                  <div key={index} className='flex gap-2'>
                    ...
                    <Button
                      ...
                      size='sm'
                      onClick={() =>
                        removeArrayItem('dataCollectionMethods', index)
                      }
                      className='border-orange-200 text-orange-700 hover:bg-orange-50'
                    >
                      Remove
                  ...
                  <Card className='border-0 shadow-sm'>
                    <CardHeader className='pb-4'>
                      ...
                      <p className='text-gray-600 mt-2'>
                        {steps[currentStep]?.description || 'Step Description'}
                      </p>
                    </CardHeader>
                          ...
                          <div className='bg-white border border-gray-200 rounded-lg p-3 shadow-sm'>
                            ...
                            <div className='space-y-1 mb-3'>
                              ...
                              <p className='text-xs text-gray-500'>
                                Current:{' '}
                                {steps[currentStep]?.shortTitle || 'Step'}
                              </p>
                            </div>
                          ...
                          {researchData.topic && (
                            <div className='bg-white border border-gray-200 rounded-lg p-3 shadow-sm'>
                              ...
                              <p className='text-xs text-gray-600 mb-3 line-clamp-2'>
                                ...
                                reproductive health service access among youth
                              </p>
