...
const sites = [
  ...
  },
  {
    ...
    name: 'Mathare',
    country: 'Kenya',
    description: 'Nairobi informal settlement',
  },
  {
    id: 4,
    name: 'Kampala Urban',
    country: 'Uganda',
    description: 'Urban research site',
  },
  {
    id: 5,
    name: 'Dar es Salaam',
    country: 'Tanzania',
    description: 'Coastal research site',
  },
];
            ...
            <CardContent className='pt-12 pb-12 px-8'>
              <div className='text-center'>
                ...
                <p className='text-lg text-gray-600 mb-8 leading-relaxed'>
                  ...
                  We&apos;ll contact you via email once your account is
                  approved.
                </p>
      ...
      <div className='max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16'>
        <div className='text-center mb-12'>
          ...
          <p className='text-xl text-gray-600 max-w-2xl mx-auto leading-relaxed'>
            Join the A-SEARCH platform to collect, access, and analyze
            population and health data across African research sites
          </p>
        </div>
          ...
          <CardHeader className='text-center pb-8'>
            <div className='w-full max-w-3xl mx-auto'>
              ...
              <p className='text-gray-600'>
                Please provide the following information to help us process your
                account request
              </p>
            </div>
          </CardHeader>
