  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      if (
        ...
        toast.error(
          'Cannot delete site: It is being used by other records (villages, structures, etc.)'
        );
      } else if (
        ...
        toast.error(
          "Permission denied: You don't have access to delete this site"
        );
      } else {
      ...
      <div className='flex items-center justify-between'>
        <div>
          ...
          <p className='text-gray-600'>
            Manage research sites and their locations
          </p>
        </div>
                  ...
                  <TableCell>
                    <div className='flex items-center space-x-1'>
                      ...
                      <span className='text-sm'>
                        ...
                        {site.end_date &&
                          ` - ${new Date(site.end_date).toLocaleDateString()}`}
                      </span>
                    </div>
                  </TableCell>
                  <TableCell>
      ...
      >
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              This will permanently delete the site &quot;{selectedSite?.name}
