...
import { Plus, Edit, Trash2, Globe, MoreHorizontal } from 'lucide-react';
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      if (
        ...
        toast.error(
          'Cannot delete country: It is being used by other records (sites, villages, etc.)'
        );
      } else if (
        ...
        toast.error(
          "Permission denied: You don't have access to delete this country"
        );
      } else {
      ...
      <div className='flex items-center justify-between'>
        <div>
          ...
          <p className='text-gray-600'>
            Manage research countries and their status
          </p>
        </div>
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              {selectedCountry?.name}&quot;. This action cannot be undone.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
