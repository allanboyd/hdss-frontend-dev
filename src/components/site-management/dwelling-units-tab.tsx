...
export function DwellingUnitsTab({ searchQuery }: DwellingUnitsTabProps) {
  ...
  const [selectedDwellingUnit, setSelectedDwellingUnit] =
    useState<DwellingUnit | null>(null);
  ...
  const handleAdd = async () => {
    if (
      ...
      !formData.occupancy_status.trim()
    ) {
      toast.error(
        'Please fill in all required fields (Unit Code, Structure, Unit Type, and Occupancy Status)'
      );
      return;
    }
    ...
    try {
      ...
      const errorMessage =
        error instanceof Error
          ? error.message
          : 'Failed to create dwelling unit';
  ...
  const handleEdit = async () => {
    ...
    try {
      await dwellingUnitService.update(
        selectedDwellingUnit.dwelling_unit_id,
        formData
      );
      ...
      const errorMessage =
        error instanceof Error
          ? error.message
          : 'Failed to update dwelling unit';
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      const errorMessage =
        error instanceof Error
          ? error.message
          : 'Failed to delete dwelling unit';
      ...
      if (
        ...
        toast.error(
          'Cannot delete dwelling unit: It is being used by other records'
        );
      } else if (
        ...
        toast.error(
          "Permission denied: You don't have access to delete this dwelling unit"
        );
      } else {
      ...
      <div className='flex items-center justify-between'>
        <div>
          ...
          <p className='text-gray-600'>
            Manage individual dwelling units within structures
          </p>
        </div>
            ...
            <div className='space-y-4'>
              <div>
                ...
                <Select
                  ...
                  onValueChange={value =>
                    setFormData({ ...formData, structure_id: parseInt(value) })
                  }
                >
                  <SelectTrigger>
                  ...
                  <SelectContent>
                    {structures.map(structure => (
                      <SelectItem
                        ...
                        value={structure.structure_id.toString()}
                      >
                        {structure.structure_code} - {structure.village?.name} (
      ...
      <div className='table-container'>
        <div className='px-6 py-4 border-b border-gray-200'>
          <h3 className='text-lg font-semibold text-gray-900'>
            Dwelling Units ({filteredDwellingUnits.length})
          </h3>
        </div>
        <div className='p-0'>
          <Table>
      ...
      >
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              This will permanently delete the dwelling unit &quot;
              {selectedDwellingUnit?.unit_code}&quot;. This action cannot be
              undone.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
