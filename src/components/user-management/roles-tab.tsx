...
import { Plus, Edit, Trash2, MoreHorizontal, Shield } from 'lucide-react';
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      if (
        ...
        toast.error(
          'Cannot delete role: It is being used by users or other records'
        );
      } else if (
        ...
        toast.error(
          "Permission denied: You don't have access to delete this role"
        );
      } else {
                ...
                <div>
                  ...
                  >
                    <div className='flex items-center space-x-2'>
                      ...
                      <Label htmlFor='default-true' className='text-sm'>
                        Yes
                      </Label>
                    </div>
                    <div className='flex items-center space-x-2'>
                      <RadioGroupItem value='false' id='default-false' />
                      <Label htmlFor='default-false' className='text-sm'>
                        No
                      </Label>
                    </div>
                  </RadioGroup>
                ...
                <div>
                  ...
                  >
                    <div className='flex items-center space-x-2'>
                      ...
                      <Label htmlFor='system-true' className='text-sm'>
                        Yes
                      </Label>
                    </div>
                    <div className='flex items-center space-x-2'>
                      <RadioGroupItem value='false' id='system-false' />
                      <Label htmlFor='system-false' className='text-sm'>
                        No
                      </Label>
                    </div>
                  </RadioGroup>
              ...
              <div>
                ...
                >
                  <div className='flex items-center space-x-2'>
                    ...
                    <Label htmlFor='edit-default-true' className='text-sm'>
                      Yes
                    </Label>
                  </div>
                  <div className='flex items-center space-x-2'>
                    <RadioGroupItem value='false' id='edit-default-false' />
                    <Label htmlFor='edit-default-false' className='text-sm'>
                      No
                    </Label>
                  </div>
                </RadioGroup>
              ...
              <div>
                ...
                >
                  <div className='flex items-center space-x-2'>
                    ...
                    <Label htmlFor='edit-system-true' className='text-sm'>
                      Yes
                    </Label>
                  </div>
                  <div className='flex items-center space-x-2'>
                    <RadioGroupItem value='false' id='edit-system-false' />
                    <Label htmlFor='edit-system-false' className='text-sm'>
                      No
                    </Label>
                  </div>
                </RadioGroup>
