...
export function PendingRequestsTab({ searchQuery }: PendingRequestsTabProps) {
  ...
  const loadData = async () => {
    try {
      setLoading(true);
      const requestsData =
        await userAccountRequestService.getByStatus('pending');
    ...
    try {
      ...
      if (siteId) {
        ...
        if (siteUserError) {
          ...
          await supabaseAdmin.auth.admin.deleteUser(authData.user.id);
          throw new Error(
            `Site user creation failed: ${siteUserError.message}`
          );
        }
      }
      ...
      if (updateError) {
        ...
        if (siteId) {
          await supabaseAdmin
            .from('site_user')
            .delete()
            .eq('user_profile_id', profileData.user_id);
        }
        await supabaseAdmin
          .from('user_profile')
          .delete()
    ...
    <div className='space-y-6'>
      ...
      <div className='flex items-center justify-between'>
        ...
        <div className='flex items-center space-x-2'>
          ...
          <span className='text-sm text-gray-600'>
            ...
            {filteredRequests.length !== 1 ? 's' : ''} pending review
          </span>
        </div>
      </div>
        ...
        <Card>
          <CardContent className='flex flex-col items-center justify-center py-12'>
            ...
            <p className='text-gray-600 text-center max-w-md'>
              All account requests have been reviewed. New requests will appear
              here when submitted.
            </p>
          </CardContent>
        </Card>
      ...
      {filteredRequests.length > 0 && (
        <Card>
          <CardHeader>
            <CardTitle>
              Pending Account Requests ({filteredRequests.length})
            </CardTitle>
          </CardHeader>
          <CardContent>
            <Table>
              ...
              <div className='p-4 bg-gray-50 rounded-lg'>
                ...
                <div className='grid grid-cols-2 gap-4 text-sm'>
                  ...
                  <div>
                    ...
                    {selectedRequest.requested_site?.name || 'No site assigned'}
                  </div>
                  <div>
              ...
              <div className='space-y-4'>
                ...
                <div className='p-4 bg-blue-50 rounded-lg'>
                  ...
                  <p className='text-sm text-blue-700'>
                    ...
                    <strong>{selectedRequest.email}</strong> with the login
                    credentials.
                  </p>
                  {emailSent && (
      ...
      <Dialog open={isReviewDialogOpen} onOpenChange={setIsReviewDialogOpen}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Are you sure you want to reject this account request? The user
