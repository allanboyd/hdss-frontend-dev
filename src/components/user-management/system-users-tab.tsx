...
export function SystemUsersTab({ searchQuery }: SystemUsersTabProps) {
  ...
  const handleAdd = async () => {
    if (
      ...
      toast.error(
        'Please fill in all required fields (Email, Full Name, Role, and Password)'
      );
      return;
    }
    ...
    try {
      ...
      if (formData.site_id) {
        ...
        try {
          ...
          toast.success(
            'User created successfully, but site assignment failed'
          );
        }
      } else {
  ...
  const handleEdit = async () => {
    ...
    if (
      ...
      toast.error(
        'Please fill in all required fields (Email, Full Name, and Role)'
      );
      return;
    }
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      if (
        ...
        toast.error(
          "Permission denied: You don't have access to delete this user"
        );
      } else {
              ...
              <div>
                ...
                <Select
                  ...
                  onValueChange={value =>
                    setFormData({
                      ...formData,
                      site_id: value === 'none' ? undefined : parseInt(value),
                    })
                  }
                >
                  <SelectTrigger className='w-full'>
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              {selectedUser?.full_name}&quot;. This action cannot be undone.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
