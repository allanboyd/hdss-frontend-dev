      ...
      <div className='flex items-center justify-between gap-4'>
        ...
        <div className='flex items-center space-x-2 sm:space-x-3'>
          <Button
            variant='ghost'
            size='sm'
            className='w-8 h-8 sm:w-10 sm:h-10 p-0 rounded-full bg-gray-100 hover:bg-gray-200'
          >
          ...
          <Button
            variant='ghost'
            size='sm'
            className='w-8 h-8 sm:w-10 sm:h-10 p-0 rounded-full bg-gray-100 hover:bg-gray-200 relative'
          >
