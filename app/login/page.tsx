            ...
            <>
              ...
              <div className="space-y-4">
                <p className="text-center text-gray-600 text-sm font-medium">
                  {isSignUp ? 'Already have an account?' : "It's my first time accessing A-SEARCH"}
                </p>
                ...
                <div className="space-y-3">
                  ...
                  >
                    {isSignUp ? 'Sign In Instead' : 'Get Started (INSPIRE Member)'}
                  </Button>
                </div>
              </div>
            </>
          ...
          {showAccountRequest && !isRequestSuccess && (
            <div className="w-full">
              <div className="text-center mb-8">
                ...
                <p className="text-gray-600">
                  Fill out the form below to request access to the A-SEARCH platform
                </p>
              </div>
              ...
              <form onSubmit={handleAccountRequest} className="space-y-4">
                ...
                <div>
                  <Label htmlFor="requestEmail" className="text-gray-700 font-semibold text-sm uppercase tracking-wide">
                    Email Address *
                  </Label>
                  <Input
                    id="requestEmail"
          ...
          {showForgotPassword && !forgotPasswordSuccess && (
            <div className="w-full">
              ...
              <form onSubmit={handleForgotPassword} className="space-y-6">
                <div>
                  <Label htmlFor="forgotEmail" className="text-gray-700 font-semibold text-sm uppercase tracking-wide">
                    Email Address *
                  </Label>
                  <Input
                    id="forgotEmail"
