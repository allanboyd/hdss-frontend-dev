...
const mockFieldStudies: FieldStudy[] = [
  {
    ...
    lastUpdated: "2 hours ago",
    description: "Comprehensive survey on maternal health practices and healthcare access in urban settlements",
    objectives: [
  ...
  },
  {
    ...
    description: "In-depth interviews exploring youth migration patterns and decision-making processes",
    objectives: [
  ...
  },
  {
    ...
    lastUpdated: "3 days ago",
    description: "Systematic observation of housing conditions and infrastructure quality",
    objectives: [
...
const statusConfig = {
  ...
  under_construction: { label: 'Under Construction', color: 'bg-yellow-100 text-yellow-800' },
...
export default function HouseholdPage() {
  const [activeView, setActiveView] = useState<'main' | 'sites' | 'households' | 'individuals' | 'dwelling' | 'migration' | 'field-studies'>('main')
  ...
  const renderMainView = () => (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6">
        <div className="flex items-center gap-3 mb-4 sm:mb-0">
          ...
          <div>
            ...
            <p className="text-gray-600">Manage sites, households, individuals, and migration data</p>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {/* Sites Card */}
        <Card className="hover:shadow-lg transition-shadow duration-200 cursor-pointer" onClick={() => handleViewChange('sites')}>
          ...
          <CardContent>
            ...
            <p className="text-gray-600 mb-4">Manage settlement sites and their locations</p>
            <div className="flex items-center justify-between">
              <div className="text-sm text-gray-500">
                Total: {mockSites.reduce((acc, site) => acc + site.households, 0)} households
              </div>
        ...
        {/* Households Card */}
        <Card className="hover:shadow-lg transition-shadow duration-200 cursor-pointer" onClick={() => handleViewChange('households')}>
          <CardHeader className="pb-3">
            <div className="flex items-center justify-between">
          ...
          <CardContent>
            <h3 className="text-xl font-semibold text-gray-900 mb-2">Households</h3>
            <p className="text-gray-600 mb-4">Manage household units and family structures</p>
            <div className="flex items-center justify-between">
              <div className="text-sm text-gray-500">
                Total: {mockHouseholds.reduce((acc, hh) => acc + hh.members, 0)} members
              </div>
              <ArrowRight className="w-4 h-4 text-gray-400" />
            </div>
          </CardContent>
        ...
        {/* Individuals Card */}
        <Card className="hover:shadow-lg transition-shadow duration-200 cursor-pointer" onClick={() => handleViewChange('individuals')}>
          <CardHeader className="pb-3">
            <div className="flex items-center justify-between">
          ...
          <CardContent>
            ...
            <p className="text-gray-600 mb-4">Manage individual residents and their details</p>
            <div className="flex items-center justify-between">
              <div className="text-sm text-gray-500">
                Active: {mockIndividuals.filter(ind => ind.status === 'resident').length} residents
              </div>
              <ArrowRight className="w-4 h-4 text-gray-400" />
            </div>
          </CardContent>
        ...
        {/* Dwelling Units Card */}
        <Card className="hover:shadow-lg transition-shadow duration-200 cursor-pointer" onClick={() => handleViewChange('dwelling')}>
          <CardHeader className="pb-3">
            <div className="flex items-center justify-between">
          ...
          <CardContent>
            <h3 className="text-xl font-semibold text-gray-900 mb-2">Dwelling Units</h3>
            <p className="text-gray-600 mb-4">Manage housing units and occupancy status</p>
            <div className="flex items-center justify-between">
              <div className="text-sm text-gray-500">
                Occupied: {mockDwellingUnits.filter(unit => unit.status === 'occupied').length} units
              </div>
              <ArrowRight className="w-4 h-4 text-gray-400" />
            </div>
          </CardContent>
        ...
        <Card className="hover:shadow-lg transition-shadow duration-200 cursor-pointer" onClick={() => handleViewChange('migration')}>
          <CardHeader className="pb-3">
            <div className="flex items-center justify-between">
          ...
          <CardContent>
            <h3 className="text-xl font-semibold text-gray-900 mb-2">Migration Analysis</h3>
            <p className="text-gray-600 mb-4">Track population movement and migration patterns</p>
            <div className="flex items-center justify-between">
              <div className="text-sm text-gray-500">
                Net: +{mockMigrationData.totalEntries - mockMigrationData.totalExits}
              </div>
              <ArrowRight className="w-4 h-4 text-gray-400" />
            </div>
          </CardContent>
        ...
        {/* Field Studies Card */}
        <Card className="hover:shadow-lg transition-shadow duration-200 cursor-pointer" onClick={() => handleViewChange('field-studies')}>
          <CardHeader className="pb-3">
            <div className="flex items-center justify-between">
          ...
          <CardContent>
            <h3 className="text-xl font-semibold text-gray-900 mb-2">Population Field Studies</h3>
            <p className="text-gray-600 mb-4">Manage research studies and data collection</p>
            <div className="flex items-center justify-between">
              <div className="text-sm text-gray-500">
                Active: {mockFieldStudies.filter(study => study.status === 'active').length} studies
              </div>
              <ArrowRight className="w-4 h-4 text-gray-400" />
            </div>
          </CardContent>
        ...
        <Card className="hover:shadow-lg transition-shadow duration-200 cursor-pointer">
          ...
          <CardContent>
            ...
            <p className="text-gray-600 mb-4">Generate insights and comprehensive reports</p>
            <div className="flex items-center justify-between">
              <div className="text-sm text-gray-500">
                Reports available
              </div>
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg border border-gray-200">
        <div className="p-6 border-b border-gray-200">
          <div className="flex items-center justify-between">
            <h3 className="text-lg font-semibold text-gray-900">Settlement Sites</h3>
          ...
          <table className="w-full">
            <thead className="bg-gray-50">
              <tr>
                ...
                <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Individuals</th>
          ...
          <table className="w-full">
            <thead className="bg-gray-50">
              <tr>
                ...
                <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Site</th>
                <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Head of Household</th>
                <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Members</th>
                <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Dwelling Units</th>
                <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Status</th>
                <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Actions</th>
              </tr>
            </thead>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="flex items-center">
                      ...
                      <div className="ml-4">
                        ...
                        <div className="text-sm text-gray-500">ID: {individual.id}</div>
                      </div>
                    </div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
  ...
  const renderDwellingView = () => (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg border border-gray-200">
        <div className="p-6 border-b border-gray-200">
          <div className="flex items-center justify-between">
            <h3 className="text-lg font-semibold text-gray-900">Dwelling Units</h3>
            <div className="flex items-center gap-2">
              <div className="relative">
                <Search className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400 w-4 h-4" />
                <input
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <h2 className="text-2xl font-bold text-gray-900">Migration Analysis</h2>
        </div>
        <Button className="bg-gradient-to-r from-orange-500 to-amber-600 hover:from-orange-600 hover:to-amber-700 text-white">
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-green-600">{mockMigrationData.totalEntries}</p>
              </div>
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-red-600">{mockMigrationData.totalExits}</p>
              </div>
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-yellow-600">{mockMigrationData.hanging}</p>
              </div>
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-gray-600">{mockMigrationData.missing}</p>
              </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <CardContent>
            <div className="space-y-4">
              <div className="flex justify-between items-center">
                ...
                <span className="font-semibold">{mockMigrationData.period}</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-gray-600">Net Migration:</span>
                <span className={`font-semibold ${mockMigrationData.totalEntries - mockMigrationData.totalExits > 0 ? 'text-green-600' : 'text-red-600'}`}>
                  {mockMigrationData.totalEntries - mockMigrationData.totalExits > 0 ? '+' : ''}{mockMigrationData.totalEntries - mockMigrationData.totalExits}
                </span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-gray-600">Trend:</span>
                <Badge className={mockMigrationData.trend === 'increasing' ? 'bg-green-100 text-green-800' : mockMigrationData.trend === 'decreasing' ? 'bg-red-100 text-red-800' : 'bg-gray-100 text-gray-800'}>
                  {mockMigrationData.trend.charAt(0).toUpperCase() + mockMigrationData.trend.slice(1)}
                </Badge>
              </div>
            </div>
          </CardContent>
        ...
        <Card className="border-0 shadow-sm">
          <CardHeader>
            <CardTitle className="text-lg font-semibold">Migration Analysis</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="space-y-3">
              <div className="flex justify-between items-center p-3 bg-green-50 rounded-lg">
                ...
                <span className="font-semibold text-green-600">
                  {Math.round((mockMigrationData.totalEntries / (mockMigrationData.totalEntries + mockMigrationData.totalExits)) * 100)}%
                </span>
              </div>
              <div className="flex justify-between items-center p-3 bg-red-50 rounded-lg">
                <span className="text-sm text-gray-600">Exit Rate</span>
                <span className="font-semibold text-red-600">
                  {Math.round((mockMigrationData.totalExits / (mockMigrationData.totalEntries + mockMigrationData.totalExits)) * 100)}%
                </span>
              </div>
              <div className="flex justify-between items-center p-3 bg-yellow-50 rounded-lg">
                <span className="text-sm text-gray-600">Hanging Rate</span>
                <span className="font-semibold text-yellow-600">
                  {Math.round((mockMigrationData.hanging / (mockMigrationData.totalEntries + mockMigrationData.totalExits)) * 100)}%
                </span>
              </div>
            </div>
          </CardContent>
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <h2 className="text-2xl font-bold text-gray-900">Population Field Studies</h2>
        </div>
        <Button className="bg-gradient-to-r from-orange-500 to-amber-600 hover:from-orange-600 hover:to-amber-700 text-white">
          <Plus className="w-4 h-4 mr-2" />
          New Study
              ...
              <div className="grid grid-cols-2 gap-4 text-sm">
                <div>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs font-medium">{study.completionRate}%</span>
                  </div>
                </div>
                <div>
                  <span className="text-gray-500">Participants:</span>
                  <p className="font-semibold text-gray-900">{study.participants}/{study.targetSample}</p>
                </div>
              </div>
