...
const mockDatasets: Dataset[] = [
  {
    ...
    description: "Complete population data from the 2023 census including demographics, household composition, and migration patterns",
    category: "population",
    format: "csv",
    size: "2.3 GB",
    records: 1250000,
  ...
  },
  {
    ...
    description: "Comprehensive survey of health facilities, services, and patient data across urban settlements",
    category: "health",
    format: "excel",
    size: "856 MB",
    records: 45000,
  ...
  },
  {
    ...
    description: "Detailed assessment of housing conditions, infrastructure, and living standards in informal settlements",
    category: "housing",
    format: "json",
    size: "1.1 GB",
    records: 78000,
  ...
  },
  {
    ...
    description: "Analysis of internal and external migration patterns, reasons, and demographic impacts",
    category: "migration",
    format: "csv",
    size: "567 MB",
    records: 32000,
  ...
  },
  {
    ...
    description: "Comprehensive socioeconomic data including income, education, employment, and living standards",
...
const mockDataRequests: DataRequest[] = [
  {
    ...
    description: "Request for access to population census data for research on urban migration patterns",
    requester: "Dr. Sarah Kimani",
    dataset: "Population Census 2023",
    purpose: "Academic research on urban migration patterns and demographic changes",
    status: "approved",
  ...
  },
  {
    ...
    description: "Request for health facility data to analyze healthcare access in informal settlements",
  ...
  },
  {
    ...
    description: "Request for housing quality data to generate comprehensive housing assessment report",
  ...
  },
  {
    ...
    description: "Request for migration patterns data for academic research on population dynamics",
...
const mockDataReports: DataReport[] = [
  {
    ...
    description: "Comprehensive analysis of urban population growth patterns and demographic changes",
    type: "analysis",
  ...
  },
  {
    ...
    description: "Detailed report on healthcare access, challenges, and recommendations for informal settlements",
    type: "research",
  ...
  },
  {
    ...
    description: "Interactive dashboard showing housing quality metrics and infrastructure assessment",
    type: "dashboard",
  ...
  },
  {
    ...
    description: "Executive summary of migration trends and their impact on urban development",
    type: "summary",
...
const statusConfig = {
  ...
  socioeconomic: { label: 'Socioeconomic', color: 'bg-indigo-100 text-indigo-800' },
...
export default function DataHubPage() {
  const [activeView, setActiveView] = useState<'main' | 'datasets' | 'requests' | 'reports'>('main')
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 mt-2">Manage datasets, requests, and reports</p>
        </div>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {/* Datasets Card */}
        <Card className="hover:shadow-lg transition-shadow duration-200 cursor-pointer" onClick={() => handleViewChange('datasets')}>
          ...
          <CardContent>
            <h3 className="text-xl font-semibold text-gray-900 mb-2">Datasets</h3>
            <p className="text-gray-600 mb-4">Browse and download data</p>
            <div className="flex items-center justify-between">
              <div className="text-sm text-gray-500">
                Available: {mockDatasets.filter(d => d.status === 'available').length} datasets
              </div>
        ...
        {/* Data Requests Card */}
        <Card className="hover:shadow-lg transition-shadow duration-200 cursor-pointer" onClick={() => handleViewChange('requests')}>
          <CardHeader className="pb-3">
            <div className="flex items-center justify-between">
          ...
          <CardContent>
            <h3 className="text-xl font-semibold text-gray-900 mb-2">Data Requests</h3>
            <p className="text-gray-600 mb-4">Manage access requests</p>
            <div className="flex items-center justify-between">
              <div className="text-sm text-gray-500">
                Pending: {mockDataRequests.filter(r => r.status === 'pending').length} requests
              </div>
              <ArrowRight className="w-4 h-4 text-gray-400" />
            </div>
          </CardContent>
        ...
        {/* Data Reports Card */}
        <Card className="hover:shadow-lg transition-shadow duration-200 cursor-pointer" onClick={() => handleViewChange('reports')}>
          <CardHeader className="pb-3">
            <div className="flex items-center justify-between">
          ...
          <CardContent>
            <h3 className="text-xl font-semibold text-gray-900 mb-2">Data Reports & Analysis</h3>
            <p className="text-gray-600 mb-4">View reports</p>
            <div className="flex items-center justify-between">
              <div className="text-sm text-gray-500">
                Published: {mockDataReports.filter(r => r.status === 'published').length} reports
              </div>
              <ArrowRight className="w-4 h-4 text-gray-400" />
            </div>
          </CardContent>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="flex items-center">
                      ...
                      <div className="ml-4">
                        ...
                        <div className="text-xs text-gray-400 mt-1">Owner: {dataset.owner}</div>
                      </div>
                    </div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
  ...
  const renderRequestsView = () => (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg border border-gray-200">
        <div className="p-6 border-b border-gray-200">
          <div className="flex items-center justify-between">
            <h3 className="text-lg font-semibold text-gray-900">Data Access Requests</h3>
            <div className="flex items-center gap-2">
              <div className="relative">
                <Search className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400 w-4 h-4" />
                <input
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="flex items-center">
                      ...
                      <div className="ml-4">
                        ...
                        <div className="text-xs text-gray-400 mt-1">Requested: {request.requestDate}</div>
                      </div>
                    </div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <h2 className="text-2xl font-bold text-gray-900">Data Reports & Analysis</h2>
        </div>
        <Button className="bg-gradient-to-r from-orange-500 to-amber-600 hover:from-orange-600 hover:to-amber-700 text-white">
          <Plus className="w-4 h-4 mr-2" />
          Create Report
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="flex items-center">
                      ...
                      <div className="ml-4">
                        ...
                        <div className="text-xs text-gray-400 mt-1">Created: {report.createdDate}</div>
                      </div>
                    </div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
